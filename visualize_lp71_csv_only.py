...
def visualize_lp71_trajectory(trajectory_csv="particle_trajectory_lp71_csv.csv", 
                             field_csv="final_intensity_LP71 3.csv",
                             resolution='low',
                             plane='xy',
                             figsize=(12, 10),
                             field_alpha=0.6):
    ...
    Args:
        trajectory_csv: 轨迹数据CSV文件
        field_csv: 光场数据CSV文件
        resolution: 光场分辨率 ('low', 'medium', 'high')
        plane: 投影平面 ('xy', 'xz', 'yz')
        figsize: 图形尺寸
        field_alpha: 光场透明度
    """
...
def main():
    ...
    # 默认参数
    trajectory_file = "particle_trajectory_lp71_csv.csv"
    field_file = "final_intensity_LP71 3.csv"
